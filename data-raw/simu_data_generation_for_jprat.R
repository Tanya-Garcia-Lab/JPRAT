...
###########################
generate.datasets.uk <- function(#method=c("gamm4","new")[1],
  a0,
  iseed,
  #simus,
  #m0_qvs,
  ...
  data <- simu.data(randomeffects.covariates.dependent,z_tmp.list,x_tmp.list,
                    ...
                    par1_fzr,par2_fzr,
                    real_data,time_val,
                    p,beta0int,beta=beta0,gamma.param=gamma.param,omega.param=omega.param,
                    n=n,nmax=nmax,m=m,maxm=maxm,la=la,lb=lb,num_study=num_study,
                    np=np,gtmod=gtmod,use.random.effects=use.random.effects,
                    gen.cens.depend.z=gen.cens.depend.z)
#
#   data <- simu.data(randomeffects.covariates.dependent,z_tmp.list,x_tmp.list,
#                     delta_tmp.list, s_tmp.list=s_tmp.list,
#                     a0,axmod,num_time,censorrate,
#                     frform,fzrform,fxform,
#                     type_fr,type_fzr,type_fx,
#                     par1_fr,par2_fr,
#                     par_fu=par_fu,
#                     par1_fr2=par1_fr2,par2_fr2,mix_n,
#                     par1_fx,par2_fx=par2_fx,
#                     par1_fzr,par2_fzr=par2_fzr,
#                     real_data,time_val=time_val,
#                     p=p,beta0int=beta0int,beta=beta0,gamma.param=gamma.param,omega.param=omega.param,
#                     n=n,nmax=nmax,m=m,maxm=maxm,la=la,lb=lb,num_study=num_study,
#                     np=np,gtmod=gtmod,use.random.effects=use.random.effects,
#                     gen.cens.depend.z=gen.cens.depend.z)
#
  #names(data)
  #[1] "y_start"              "ymiss_ind_start"      "z_start"
  #[4] "x_start"              "s_start"              "q_start"
  #[7] "delta_start"          "onset_age_orig_start" "norisk_ind_start"
  #[10] "count"
