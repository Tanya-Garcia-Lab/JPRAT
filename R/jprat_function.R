...
#'
#'
#' @param theta.names a character vector of functional parameter names that will be estimated in the model: "beta" (intercept), "alphas" and "Ft" (or "Ft.predicted") corresponds to
